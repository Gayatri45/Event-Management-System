...
<%
ArrayList<HashMap> tableData = (ArrayList<HashMap>) request.getAttribute("categoryList");
%>
<div class="row">
	<div class="col-lg-12">
		<div class="card">
					...
					<table id="bootstrap-data-table-export"
						...
						<tbody class="popup">
							...
							for (int i = 0; i < tableData.size(); i++) {
								HashMap categoryList = (HashMap) tableData.get(i);
							%>
							<tr>
								<td><%=(i + 1)%></td>
								<td><%=categoryList.get("categoryName")%></td>
								<td>
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right" role="menu">
											...
											<li><a onclick="editCategoryFunc(<%=categoryList.get("categoryId")%>)" ><i
