                ...
                <div class="container-fluid">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col ml-auto  text-right">
                            <a href="/organizer/venue/add-venues" class="btn btn-success btn-sm">
                                <i class="ti-plus"></i> Add Venues
                            </a>
                        </div>
                    </div>
                </div>
								...
								<div class="card-body">
									<div class="row d-flex align-items-center">
										...
										<div class="col-md-2">
											<div class="form-group row m-b-0">
												<div class="col-md-12">
													<button type="button" onclick="loadVenue()"
    ...
    <script>
		function loadVenue() {
			...
			if (companyId == "0") {
				...
				$.ajax({
					url : '/organizer/venue/getVenueTableList', // JSP page to fetch data
					type : 'POST',
					data : {
						companyId : companyId,
						branchId : branchId
