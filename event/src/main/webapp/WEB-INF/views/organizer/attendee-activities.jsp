...
<body>
								...
								<div class="card-body">
									<div class="row d-flex align-items-center">
										...
										<div class="col-md-2">
											<div class="form-group row m-b-0">
												<div class="col-md-12">
													<button type="button" onclick="loadAttendeeLog()"
	...
	<script>
		function loadAttendeeLog() {
			...
			if (companyId == "0") {
				...
				$.ajax({
					url : '/organizer/attendee/getAttendeeActivitiesTableList', // JSP page to fetch data
					type : 'POST',
					data : {
						companyId : companyId,
						branchId : branchId
	...
	<script>
		function editAttendee(attendeeId) {
			...
			window.location = '/organizer/attendee/edit-attendee?attendeeId='+ attendeeId;
		}
	</script>
	
	<script>
		function attendeeDetails(attendeeId) {
			
			console.log(attendeeId);
			window.location = '/organizer/attendee/attendee-details?attendeeId='+ attendeeId;
		}
	</script>
