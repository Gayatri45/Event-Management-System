...
<%
ArrayList<HashMap> tableData = (ArrayList<HashMap>) request.getAttribute("venueTypeList");
%>
<div class="row">
	<div class="col-lg-12">
		<div class="card">
					...
					<table id="bootstrap-data-table-export"
						...
						<tbody class="popup">
							...
							for (int i = 0; i < tableData.size(); i++) {
								HashMap venueTypeList = (HashMap) tableData.get(i);
							%>
							<tr>
								<td><%=(i + 1)%></td>
								<td><%=venueTypeList.get("name")%></td>
								<td>
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right" role="menu">
											<li><a onclick="editVenueTypeFunc(<%=venueTypeList.get("venueTypeId")%>)" ><i
