                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col">
                            <div class="page-title">
                                <h1> <%=eventDetails.get("eventName")%> </h1>
                            </div>
                        </div>
                                              ...
                                              <!--   <tr>
                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=eventDetails.get("ticketPrice")%></td>
                                                </tr> 
                                                <%} %>
                                               <!--  <tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="cover-img text-center">
                                        <a href="<%=MyUrl.uploadedUrl%>eventImages/<%=eventDetails.get("imageGalleryName")%>" data-fancybox="gallery"> 
                                            <img src="<%=MyUrl.uploadedUrl%>eventImages/<%=eventDetails.get("imageGalleryName")%>" class="img-fluid" alt=""> </a>
                                    </div>
