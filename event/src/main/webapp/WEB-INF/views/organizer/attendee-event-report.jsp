...
<title>One Stop | Attendee Event Report</title>
...
<body>
								...
								<div class="card-body">
									<div class="row d-flex align-items-center">
										...
										<div class="col-md-2">
											<div class="form-group row m-b-0">
												<div class="col-md-12">
													<button type="button" onclick="loadAttendeeEventReport()"
	...
	<script>
		function loadAttendeeEventReport() {
			...
			if (companyId == "0") {
				...
				$.ajax({
					url : '/organizer/report/getAttendeeEventReportTableList', // JSP page to fetch data
					type : 'POST',
					data : {
						companyId : companyId,
						branchId : branchId
