...
<head>
    ...
    <title>One Stop | Participant List</title>
                ...
                <div class="container-fluid">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col ml-auto  text-right">
                            <a href="/organizer/participant/add-participant" class="btn btn-success btn-sm">
                                <i class="ti-plus"></i> Add Participant
                            </a>
                        </div>
                    </div>
                </div>
								...
								<div class="card-body">
									<div class="row d-flex align-items-center">
										...
										<div class="col-md-2">
											<div class="form-group row m-b-0">
												<div class="col-md-12">
													<button type="button" onclick="loadParticipant()"
    ...
    <script>
		function loadParticipant() {
			...
			if (companyId == "0") {
				...
				$.ajax({
					url : '/organizer/participant/getparticipantTableList', // JSP page to fetch data
					type : 'POST',
					data : {
						companyId : companyId,
						branchId : branchId
