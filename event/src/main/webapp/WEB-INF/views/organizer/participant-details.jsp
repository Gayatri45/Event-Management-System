...
<title>One Stop | Participant Details</title>
...
HashMap eventDetails = (HashMap) participantDetails.get("event");
%>
</head>
					...
					<div class="row d-flex align-items-center">
						<div class="col">
							<div class="page-title">
								<h1>
									<%=participantDetails.get("participantName")%>
								</h1>
							</div>
						</div>
						<div
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="card">
								<div class="card-body">
									<h5>
										<i class="ti-user"></i> General information
									</h5>
									<div class="table-responsive">
										<table id="bootstrap-data-table-export"
											...
											<tbody class="popup">
												...
												<tr>													
													...
													<div class="event-table-block">
															<div class="event-img">
																...
																<%
																if (participantDetails.get("profilePicName") != null) {
																	//String imgUrl = MyUrl.uploadedUrl+"eventImages/"+eventList.get("imageGalleryName");
																%>

																<a href="#" title="Zoom" data-toggle="tooltip"> <img
																	src="<%=MyUrl.uploadedUrl%>participantImages/<%=participantDetails.get("profilePicName")%>"
																	alt="" style="height: 90px; width:150px">
																</a>
																<%
																} else {
																%>
																<a href="#" title="Zoom" data-toggle="tooltip"> <img
																	src="/images/user.svg" alt="Image" style="height: 90px; width:100px">
																</a>
																<%
																}
																%>
												...
												<tr>
													<th class="border-bottom-0"><b> Participant's Name
													</b></th>
													<td><%=participantDetails.get("participantName")%></td>
												</tr>
												<tr>
													<th class="border-bottom-0"><b>Email</b></th>
													<td><%=participantDetails.get("participantEmail")%></td>
												</tr>
												<tr>
													<th class="border-bottom-0"><b>Mobile No</b></th>
													<td><%=participantDetails.get("participantPhoneNo")%></td>
												</tr>
												<tr>
													<th class="border-bottom-0"><b>Participant Address</b>
													</th>
													<td><%=participantDetails.get("participantAddress")%></td>
												</tr>
									...
									<div class="table-responsive">
										<table id="bootstrap-data-table-export"
											...
											<tbody class="popup">
												...
												<tr>
													<th class="border-bottom-0"><b> Stall Name </b></th>
													<td><%=participantDetails.get("stallName")%></td>
												</tr>
												<tr>
													<th class="border-bottom-0"><b>Description </b></th>
													<td><%=participantDetails.get("stallDescription")%></td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="table-responsive">
										<table id="bootstrap-data-table-export"
											...
											<tbody class="popup">
												...
												<tr>
													<th class="border-bottom-0"><b>Venue Email</b></th>
										...
										<table id="bootstrap-data-table-export"
											...
											<tbody class="popup">
												...
												<tr>
													...
													<td><i class="fa fa-star text-warning"
														aria-hidden="true"></i> <i class="fa fa-star text-warning"
														aria-hidden="true"></i> <i class="fa fa-star text-warning"
														aria-hidden="true"></i> <i
														class="fa fa-star-half-o text-warning" aria-hidden="true"></i>
														<i class="fa fa-star-half-o text-warning"
														aria-hidden="true"></i> <span>3 out of 5 stars</span></td>
												</tr>
											</tbody>
										</table>
									</div>
