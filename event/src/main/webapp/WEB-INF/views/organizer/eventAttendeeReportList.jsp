...
<%
ArrayList<HashMap> tableData = (ArrayList<HashMap>) request.getAttribute("eventReportList");
%>
<div class="row">
	<div class="col-lg-12">
		<div class="card">
					...
					<table id="bootstrap-data-table-export"
						...
						<thead>
							<tr>
								...
								<th class="border-bottom-0">No Of Attendee</th>
						...
						<tbody class="popup">
							...
							<tr>
								...
								<td><%=eventList.get("noOfAttendee")%></td>
