...
<body>
					...
					<div class="row d-flex align-items-center">
						...
						<div
							...
							<a class="btn btn-success btn-sm m-b-10 m-l-5"
								onclick="addCategoryFunc()"><i class="ti-plus"></i> Add
								Categories</a>
						</div>
	...
	<div class="modal fade" id="categoryModal" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered modal-md">
			<div class="modal-content">
				...
				<form id="saveCategory" name="saveCategory"
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success"
							onclick="return validateCategory()">Save</button>
					</div>
				</form>
			</div>
		</div>
	...
	<!-- Update Category -->
	<div class="modal fade" id="categoryModalEdit" tabindex="-1"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-md">
			<div class="modal-content">
				<div class="modal-header">
				...
				<form id="editSaveCategory" name="editSaveCategory"
					enctype="multipart/form-data">
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label>Category Name <span class="text-danger">*</span></label> <input
										type="text" class="form-control" name="categoryName"
										id="editCategoryName" placeholder=" ">
								</div>
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary"
							data-dismiss="modal">Close</button>
						<button type="submit" class="btn btn-success"
							onclick="return validateCategory1()">Save</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script>
		function editCategoryFunc(categoryId) {
			...
			if (branchId == "0" || branchId == "") {
				...
				$.ajax({
					type : 'POST',
					url : "/organizer/categoryAndAudience/getCategoryById",
					data : {
					...
					success : function(category) {
						...
						var parsedData = JSON.parse(category);
						...
						$("#editCategoryName").val(parsedData.categoryName);
	...
	<script>
		$('#saveCategory').submit(function(event) {
			...
			var form = document.getElementById('saveCategory');
			var formData = new FormData(form);

			$.ajax({
				url : '/organizer/categoryAndAudience/saveCategory',
				method : 'POST',
				data : formData,
				processData : false,
				contentType : false,
	...
	<script>
		function loadCategory() {
			...
			if (companyId == "0") {
				...
				$.ajax({
					url : '/organizer/categoryAndAudience/getCategoryTableList', // JSP page to fetch data
					type : 'POST',
					data : {
						companyId : companyId,
						branchId : branchId
	...
	<script>
		$('#editSaveCategory').submit(function(event) {
			event.preventDefault();
			var form = document.getElementById('editSaveCategory');
			var formData = new FormData(form);
