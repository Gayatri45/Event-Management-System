...
<head>
    ...
    <title>One Stop | Check Out Scan</title>
    ...
    <script>        
		...
		function scanqrPass() { 
		 ...
		 function onScanSuccess(qrCodeMessage) {			   
			   ...
			   $.ajax({
					type : 'POST',
					url : "/participant/scanner/checkOutAttendee",
					data : {
						qrCodeMessage : qrCodeMessage
					},
					dataType : "text",
					success : function(checkOutAttendee) {						
					
						var response = JSON.parse(checkOutAttendee);
