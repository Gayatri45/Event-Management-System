...
<title>OneStop | Participant Profile</title>
<!-- ================= Favicon ================== -->
<!-- Standard -->
...
<body>
							...
							<div class="col-lg-8 m-auto">
								<div class="card">
									...
									<div class="card-body">
										...
										<input type="hidden" name="companyId" value="<%=participantDetails.get("companyId")%>" /> 
										<input type="hidden" name="branchId" value="<%=participantDetails.get("branchId")%>" /> 
										<input type="hidden" name="participantId" value="<%=participantDetails.get("participantId")%>" />
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label>Participant Name <span class="requiredFiled">*</span></label>
															<input type="text" id="fname" name="participantName"
																class="form-control"
																value="<%=participantDetails.get("participantName")%>">
														</div>
													</div>												
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="email" name="participantEmail"
																class="form-control"
																value="<%=participantDetails.get("participantEmail")%>" readonly=""
																data-toggle="tooltip"
														...
														<div class="form-group">
															...
															<div class="d-flex align-items-center position-relative">
																<span class="isdPlus"><strong>+</strong></span> <input
																	type="number" class="form-control" id="isd"
																	...
																	name="participantPhoneNo" autocomplete="off"
																	onfocus="removeWarning(this)"
																	onkeypress="validNumber(event, this)"
																	value=<%=participantDetails.get("participantPhoneNo")%> maxlength="10"
													...
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															...
															<div class="thumb">
																 ...
																 <img class="img-size" name="profilePic" id="file-photo" alt="pic" src="">																
															</div>

															<input type="hidden" name="profilePic" id="image-file" />
														</div>
																...
																<div class="imgupl">
																	<div class="file-tab">
																		<label class="btn btn-sm btn-default btn-file m-b-0">
																			<span>Upload Picture</span> <input type="file" name="profilePic">
																		</label>
				...
				<div class="modal-body">
					...
					<form name="updatePassword" id="updatePassword" method="post">
						...
						<input type="hidden" name="email"
							value="<%=participantDetails.get("participantEmail")%>" class="displayNone" />
						<div class="form-group">
							<!-- Current Password -->
							...
							<div class="input-group input-group-merge">
								<input id="opss" type="password" name="oldPassword"
	...
	<!--<script src="gatepass/onestop.imageupload.js"></script>-->
	...
	<script>
		...
		if ("<%=participantDetails.get("profilePhotoFileName")%>" !== null) {
			document.getElementById('file-photo').setAttribute('src', '<%=MyUrl.uploadedUrl%>participantImages/<%=participantDetails.get("profilePicName")%>');
		} else {
			document.getElementById('file-photo').setAttribute('src', '/images/user.svg');
		}
		(function() {
	...
	<script>
		$('#updatePassword').submit(function(event) {
			...
			$.ajax({
				url : '/participant/changeUserPassword',
				method : 'POST',
				data : formData,
				processData : false,
				contentType : false,
	...
	function validateProfile(){
		...
		if (fname == "" || null) {
			swal("Oops...", "Please Enter Participant Name !!", "warning");
			$('#fname').focus();			
			return false;
		} 
		if (mobile == "" || null) {
